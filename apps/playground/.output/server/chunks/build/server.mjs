...
import { ssrRenderAttrs, ssrGetDirectiveProps, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const unhead_1oeKJr8Lx0abb_YoeH_AR_GNJy1RGlnieJEvweA1nig = defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const router_acGZ196DlDrQivCsDDOsZkKrj1qse6ZYGtRiGbGT1Vs = defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
const revive_payload_server_U0aapv33_0NiI0EYRu_pa1kc_HuulmJZgCAklJerMV8 = defineNuxtPlugin({
...
const switchContext = /* @__PURE__ */ new WeakMap();
function getParentAndSwitchValue(el) {
...
async function copyListener(value) {
...
const nuxt_F_6YQuQqAT7vodzEUfoYoOGytL0NYxm_zjxyMD2ybOY = defineNuxtPlugin((nuxtApp) => {
  installDirectives(nuxtApp.vueApp);
});

const plugins = [
  unhead_1oeKJr8Lx0abb_YoeH_AR_GNJy1RGlnieJEvweA1nig,
  router_acGZ196DlDrQivCsDDOsZkKrj1qse6ZYGtRiGbGT1Vs,
  revive_payload_server_U0aapv33_0NiI0EYRu_pa1kc_HuulmJZgCAklJerMV8,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4,
  nuxt_F_6YQuQqAT7vodzEUfoYoOGytL0NYxm_zjxyMD2ybOY
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "top-div" }, _attrs))}><p${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_copy))}>Copy this text by clicking on it</p><button${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_focus))}>Focuses automatically</button></div>`);
}
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.16.2_@netlify+blobs@8.2.0_@parcel+watcher@2.5.1_@types+node@22.14.1_db0@0.3.1_io_bbc0293f20d644b61aa9e5c161f77503/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.16.2_@netlify+blobs@8.2.0_@parcel+watcher@2.5.1_@types+node@22.14.1_db0@0.3.1_io_bbc0293f20d644b61aa9e5c161f77503/node_modules/nuxt/dist/app/components/nuxt-root.vue");
